...
[![CI](https://github.com/slepher/rebar3_erlando/actions/workflows/release.yml/badge.svg?branch=0.4.5&event=push)](https://github.com/slepher/rebar3_erlando/actions/workflows/release.yml?query=branch%3A0.4.5)
